...
(let* ( [shutdown-json (read-string "./tests/resources/shutdown.json") ]
		...
		"    \"params\": {\n" 
		"        \"processId\": 1,\n"
		"        \"rootPath\": \"" (string-append (current-directory) "/util") "\",\n"
		"        \"rootUri\": \"file://" (string-append (current-directory) "/util") "\",\n"
		"        \"capabilities\": {}\n"
		"    },\n" 
		"    \"jsonrpc\": \"2.0\"\n" 
		"}")]
        ...
        [formatting-json (format (read-string "./tests/resources/formatting.json") (current-directory))]
        [formatting-header (string-append 
        ; "GET /example.http HTTP/1.1\r\n"
        "Content-Length: "
        (number->string (bytevector-length (string->utf8 formatting-json)))
        "\r\n\r\n")]
        ...
        [input-port (open-bytevector-input-port (string->utf8 
                (string-append 
                    ...
                    formatting-header formatting-json
