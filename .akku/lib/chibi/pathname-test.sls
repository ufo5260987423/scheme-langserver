#!r6rs
;; Akku.scm wrote this file based on "chibi-pathname-0.9.0/chibi/pathname-test.sld"
(library
  (chibi pathname-test)
  (export run-tests)
  (import
  ...
  (define (run-tests)
    ...
    (test "path-directory:extra"
          "/usr/local"
          (path-directory "/usr/local/lib"))
    (test "lib"
          (path-strip-directory "/usr/local/lib"))
    ...
    (test "path-replace-extension"
          "foo.c"
          (path-replace-extension "foo.scm" "c"))
    ...
    (test "a/b"
          (path-strip-leading-parents "../../a/b"))
    (test "a/b"
          (path-strip-leading-parents "../../../a/b"))
    (test "a/../b"
          (path-strip-leading-parents "../../../a/../b"))
    (test "path-relative-to"
          "c"
          (path-relative-to "/a/b/c" "/a/b"))
