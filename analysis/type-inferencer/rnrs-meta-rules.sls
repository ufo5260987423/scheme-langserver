...
(display-string (void? x) (string? x) (and (output-port? x) (textual-port? x)))
(div0 (number? x) (number? x) (number? x))
(div0-and-mod0 (number? x) (number? x) (number? x))
(open-bytevector-input-port (and (input-port? x) (binary-port? x)) (bytevector? x))
(open-bytevector-input-port (and (input-port? x) (binary-port? x)) (bytevector? x) (transcoder? x))
(open-bytevector-output-port (and (output-port? x) (binary-port? x)))
...
(put-char (void? x))
(put-datum (void? x) (and (output-port? x) (text-port? x)) (something? x))
...
(reverse! (void? x))
(set! (void? x))
(set-binary-port-input-buffer! (void? x) (and (input-port? x) (binary-port? x))(bytevector? x))
(set-binary-port-input-index! (void? x))
(set-binary-port-input-size! (void? x))
(set-binary-port-output-buffer! (void? x) (and (output-port? x) (binary-port? x)) (bytevector? x))
...
(vector-cas! (void? x) (vector? x) (integer? x) (old-obj)
(vector-fill! (void? x))
(vector-set! (void? x))
