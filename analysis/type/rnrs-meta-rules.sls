...
(char- (integer? x) ((char? x) (char? x)))
(char- (boolean=? #f x) ((char? x) (char? x)))
(char-general-category (symbol? x) ((char? x)))
(char-name (or (symbol? x) (boolean=? #f x) (char? x)) ((char? x)))
(char-name (or (symbol? x) (boolean=? #f x) (char? x)) ((symbol? x)))
