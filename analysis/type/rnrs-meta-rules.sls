...
(add1 number? (number?))
(alias something? ())
(andmap boolean? ((something? <- (something? ...)) (something?) **1))
(angle number? (number?))
...
(bytevector->s8-list (something? ...)())
(bytevector->sint-list (something? ...)())
(bytevector->string string? ())
(bytevector->u8-list (something? ...)())
(bytevector->uint-list (something? ...)())
...
(bytevector=? boolean? (#(something? ...) #(something? ...)))
(bytevector? boolean? (something?))
(call-with-bytevector-output-port void? ((something? <- (something? ...))))
(call-with-bytevector-output-port void? ((something? <- (something? ...)) transcoder?))
(call-with-current-continuation something? ((something? <- (something? ...))))
(call-with-input-file something? ())
(call-with-input-file void? (string? (something? <- (something? ...))))
(call-with-output-file something? ())
(call/1cc something? ((something? <- (something? ...))))
(call/cc something? ((something? <- (something? ...))))
...
(compute-composition integer? (something? (something? <- (something? ...))))
(compute-composition integer? (something?))
(compute-size integer? (something? (something? <- (something? ...))))
...
(fxvector #(something? ...) (fixnum? ...))
(fxvector->immutable-fxvector #(something? ...)())
(fxvector->list (something? ...) (#(something? ...)))
(fxvector-copy #(something? ...)())
(fxvector-fill! void? (#(fixnum? ...) fixnum?))
(fxvector-length integer? ())
(fxvector-ref fixnum? ())
(fxvector-set! void? (#(fixnum? ...) integer? fixnum?))
...
(guardian? fixnum? (something?))
(hash-table? #(something? ...) (something?))
(hashtable-clear! void? ())
(hashtable-contains? #(something? ...)())
(hashtable-delete! void? ())
(hashtable-ephemeron? #(something? ...) (something?))
(hashtable-mutable? #(something? ...)())
(hashtable-set! void? ())
(hashtable-size integer? ())
(hashtable-update! void? ())
(hashtable-weak? #(something? ...) (something?))
(hashtable? #(something? ...) (something?))
(i/o-decoding-error? integer? (something?))
(i/o-encoding-error? (something? ...) (something?))
(i/o-error-filename string? ())
(i/o-error-port port? ())
(i/o-error-position integer? ())
(i/o-error? void? (something?))
(i/o-file-already-exists-error? void? (something?))
...
(make-fxvector #(something? ...) (integer? fixnum?))
(make-fxvector #(something? ...)())
...
(multibyte->string string? (#(something? ...)))
...
(oblist (something? ...)())
(odd? boolean? ())
(open-bytevector-input-port binary-port? (#(something? ...)))
(open-bytevector-input-port binary-port? (#(something? ...) transcoder?))
(open-bytevector-input-port input-port? (#(something? ...)))
(open-bytevector-input-port input-port? (#(something? ...) transcoder?))
...
(remove! void? (something?  (something? ...)))
(remove-hash-table! void? ())
(remove-registry! void? ())
(remq! void? (something? (something? ...)))
(remv! void? (something? (something? ...)))
...
(set! void? ())
(set-binary-port-input-buffer! void? (binary-input-port? #(something? ...)))
(set-binary-port-input-index! void? ())
(set-binary-port-input-size! void? ())
(set-binary-port-output-buffer! void? (binary-output-port? #(something? ...)))
...
(trace-case-lambda (something? <- (something? ...))())
(trace-lambda (something? <- (something? ...))())
(transcoder? boolean? (something?))
(truncate real? (real?))
(u8-list->bytevector boolean? ())
(uint-list->bytevector boolean? ())
(undefined-violation? boolean? (something?))
(utf16->string string? (#(something? ...)))
(utf32->string string? (#(something? ...)))
(utf8->string string? (#(something? ...)))
(vector vector? (something? ...))
(vector->immutable-vector immutable-vector? ())
(vector->list (something? ...) (#(something? ...)))
(vector-cas! void? (#(something? ...) integer? something? something?))
(vector-copy vector? ())
(vector-fill! void? ())
