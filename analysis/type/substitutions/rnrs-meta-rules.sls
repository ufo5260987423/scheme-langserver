...
; (-1+ (number? <- (inner:list? number?)))
; (1- (number? <- (inner:list? number?)))
(abort (inner:void? <- (inner:list? something? ...)))
...
(box-cas! (inner:void? <- (inner:list? box? something? something?)))
(box-immutable (box? <- (inner:list? something?)))
(box (box? <- (inner:list? something?)))
(bwp-object? (boolean? <- (inner:list? something?)))
(bytes-allocated (integer? <- (inner:list?)))
(bytevector->string (string? <- (inner:list? bytevector?)))
(bytevector->string (string? <- (inner:list? bytevector? transcoder?)))
(bytevector->u8-list ((inner:list? integer? ...) <- (inner:list? bytevector?)))
(bytevector-copy (bytevector? <- (inner:list? bytevector?)))
(bytevector-copy (bytevector? <- (inner:list? bytevector? integer?)))
(bytevector-copy (bytevector? <- (inner:list? bytevector? integer? integer?)))
(bytevector-copy! (inner:void? <- (inner:list? bytevector? integer? bytevector?)))
(bytevector-copy! (inner:void? <- (inner:list? bytevector? integer? bytevector? integer?)))
(bytevector-copy! (inner:void? <- (inner:list? bytevector? integer? bytevector? integer? integer?)))
(bytevector-fill! (inner:void? <- (inner:list? bytevector? integer?)))
(bytevector-length (integer? <- (inner:list? bytevector?)))
(bytevector-s16-native-ref (integer? <- (inner:list? bytevector? integer?)))
(bytevector-s16-native-set! (inner:void? <- (inner:list? bytevector? integer? integer?)))
(bytevector-s16-ref (integer? <- (inner:list? bytevector? integer? something?)))
(bytevector-s16-set! (inner:void? <- (inner:list? bytevector? integer? integer? something?)))
(bytevector-s32-native-ref (integer? <- (inner:list? bytevector? integer?)))
(bytevector-s32-native-set! (inner:void? <- (inner:list? bytevector? integer? integer?)))
(bytevector-s32-ref (integer? <- (inner:list? bytevector? integer? something?)))
(bytevector-s32-set! (inner:void? <- (inner:list? bytevector? integer? integer? something?)))
(bytevector-s8-ref (integer? <- (inner:list? bytevector? integer?)))
(bytevector-s8-set! (inner:void? <- (inner:list? bytevector? integer? integer?)))
(bytevector-u16-native-ref (integer? <- (inner:list? bytevector? integer?)))
(bytevector-u16-native-set! (inner:void? <- (inner:list? bytevector? integer? integer?)))
(bytevector-u16-ref (integer? <- (inner:list? bytevector? integer? something?)))
(bytevector-u16-set! (inner:void? <- (inner:list? bytevector? integer? integer? something?)))
(bytevector-u32-native-ref (integer? <- (inner:list? bytevector? integer?)))
(bytevector-u32-native-set! (inner:void? <- (inner:list? bytevector? integer? integer?)))
(bytevector-u32-ref (integer? <- (inner:list? bytevector? integer? something?)))
(bytevector-u32-set! (inner:void? <- (inner:list? bytevector? integer? integer? something?)))
(bytevector-u8-ref (integer? <- (inner:list? bytevector? integer?)))
(bytevector-u8-set! (inner:void? <- (inner:list? bytevector? integer? integer?)))
...
(cadar (with ((a b c ...)) (with-equal? inner:list? a ((with ((d e f ...)) (with-equal? inner:list? d ((with ((g h i ...)) (with-equal? inner:list? g h)) (with-append (inner:list?) f)))) b))))
...
(cadr (something? <- (inner:list? (inner:pair? something? something?))))
(call-with-bytevector-output-port (bytevector? <- (inner:list? (something? <- (inner:list? output-port?)))))
(call-with-current-continuation (something? <- (inner:list? (something? <- (inner:list? something?)))))
(call-with-input-file (something? <- (inner:list? string? (something? <- (inner:list? input-port?)))))
(call-with-output-file (something? <- (inner:list? string? (something? <- (inner:list? output-port?)))))
(call-with-port (something? <- (inner:list? port? (something? <- (inner:list? port?)))))
(call-with-string-output-port (string? <- (inner:list? (something? <- (inner:list? output-port?)))))
(call-with-values (something? <- (inner:list? (something? <- (inner:list?)) (something? <- (inner:list? something? ...)))))
...
(cddar (with ((a b c ...)) (with-equal? inner:list? a ((with ((d e f ...)) (with-equal? inner:list? d ((with ((g h i ...)) (with-equal? inner:list? g (with-append (inner:list?) i))) (with-append (inner:list?) f)))) b))))
...
(clear-input-port (inner:void? <- (inner:list? )))
(clear-input-port (inner:void? <- (inner:list? input-port?)))
(clear-output-port (inner:void? <- (inner:list? )))
(clear-output-port (inner:void? <- (inner:list? output-port?)))
(close-input-port (inner:void? <- (inner:list? input-port?)))
(close-output-port (inner:void? <- (inner:list? output-port?)))
(close-port (inner:void? <- (inner:list? port?)))
(collect (inner:void? <- (inner:list? )))
(collect (inner:void? <- (inner:list?)))
(collections (integer? <- (inner:list? )))
(collect-rendezvous (inner:void? <- (inner:list? )))
(collections (integer? <- (inner:list?)))
(command-line ((inner:list? string? ...) <- (inner:list? )))
(command-line-arguments ((inner:list? string? ...) <- (inner:list?)))
(compile-file (something? <- (inner:list? string?)))
(compile-library (something? <- (inner:list? string?)))
(compile-program (something? <- (inner:list? string?)))
(compile-script (something? <- (inner:list? string?)))
(compile-time-value-value (something? <- (inner:list? compile-time-value?)))
(compile-time-value? (boolean? <- (inner:list? something?)))
(complex? (boolean? <- (inner:list? something?)))
(compose (something? <- (inner:list? procedure? procedure?)))
(condition-broadcast (inner:void? <- (inner:list? condition?)))
(condition-continuation (something? <- (inner:list? something?)))
(condition-irritants (something? <- (inner:list? something?)))
(condition-message (something? <- (inner:list? something?)))
(condition-signal (inner:void? <- (inner:list? condition?)))
(condition-wait (inner:void? <- (inner:list? condition? mutex?)))
(condition-wait (inner:void? <- (inner:list? condition? mutex? something?)))
(condition-who (something? <- (inner:list? something?)))
...
(console-error-port (output-port? <- (inner:list?)))
(console-input-port (input-port? <- (inner:list?)))
(console-output-port (output-port? <- (inner:list?)))
...
(cpu-time (integer? <- (inner:list?)))
(critical-section (something? <- (inner:list? (something? <- (inner:list? something? ...)))))
(current-date (date? <- (inner:list? )))
(current-date (date? <- (inner:list? integer?)))
(current-date (date? <- (inner:list?)))
(current-directory (string? <- (inner:list?)))
(current-directory (string? <- (inner:list? string?)))
(current-error-port (output-port? <- (inner:list?)))
(current-input-port (input-port? <- (inner:list?)))
(current-output-port (output-port? <- (inner:list?)))
(current-time (time? <- (inner:list? )))
(current-time (time? <- (inner:list? symbol?)))
(date->time-utc (time? <- (inner:list? date?)))
...
(delete-directory (inner:void? <- (inner:list? string?)))
(delete-file (inner:void? <- (inner:list? string?)))
...
(display-statistics (inner:void? <- (inner:list? )))
(display-string (inner:void? <- (inner:list? string?)))
(display (inner:void? <- (inner:list? something?)))
(div0 (number? <- (inner:list? number? number?)))
(div (number? <- (inner:list? number? number?)))
(dynamic-wind (something? <- (inner:list? (something? <- (inner:list?)) (something? <- (inner:list? something? ...)) (something? <- (inner:list?)))))
(environment (environment? <- (inner:list? something? ...)))
(environment-mutable? (boolean? <- (inner:list? environment?)))
(environment-symbols ((inner:list? symbol? ...) <- (inner:list? environment?)))
...
(eq-hashtable-cell ((inner:pair? something? something?) <- (inner:list? eq-hashtable? something? something?)))
(eq-hashtable-contains? (boolean? <- (inner:list? eq-hashtable? something?)))
(eq-hashtable-delete! (inner:void? <- (inner:list? eq-hashtable? something?)))
(eq-hashtable-ref (something? <- (inner:list? eq-hashtable? something? something?)))
(eq-hashtable-set! (inner:void? <- (inner:list? eq-hashtable? something? something?)))
(eq-hashtable-update! (inner:void? <- (inner:list? eq-hashtable? something? (something? <- something?) something?)))
...
(error (inner:void? <- (inner:list? something? something? **1)))
(eval (something? <- (inner:list? something? environment?)))
...
(exit (something? <- (inner:list?)))
(exit (something? <- (inner:list? something?)))
(expand (something? <- (inner:list? something?)))
(expand/optimize (something? <- (inner:list? something?)))
(expt (number? <- (inner:list? number? number?)))
(fasl-read (something? <- (inner:list?)))
(fasl-read (something? <- (inner:list? input-port?)))
(fasl-write (inner:void? <- (inner:list? something?)))
(fasl-write (inner:void? <- (inner:list? something? output-port?)))
(file-access-time (time? <- (inner:list? string?)))
(file-buffer-size (integer? <- (inner:list?)))
(file-change-time (time? <- (inner:list? string?)))
...
(file-modification-time (time? <- (inner:list? string?)))
...
(flush-output-port (flonum? <- (inner:list? )))
(flush-output-port (inner:void? <- (inner:list?)))
(flush-output-port (inner:void? <- (inner:list? output-port?)))
...
(foreign-entry (something? <- (inner:list? string?)))
(foreign-entry? (boolean? <- (inner:list? string?)))
(foreign-sizeof (integer? <- (inner:list? symbol?)))
(fork-thread (thread? <- (inner:list? (something? <- (inner:list?)))))
(format-condition? (boolean? <- (inner:list? something?)))
(fresh-line (inner:void? <- (inner:list?)))
(fresh-line (inner:void? <- (inner:list? output-port?)))
...
(fxvector-fill! (inner:void? <- (inner:list? (inner:vector? fixnum? ...) fixnum?)))
(fxvector-ref (fixnum? <- (inner:list? (inner:vector? fixnum? ...) integer?)))
(fxvector-set! (inner:void? <- (inner:list? (inner:vector? fixnum? ...) integer? fixnum?)))
...
(gensym (symbol? <- (inner:list?)))
(gensym (symbol? <- (inner:list? string?)))
(gensym (symbol? <- (inner:list? string? string?)))
(gensym->unique-string (string? <- (inner:list? symbol?)))
(gensym-count (integer? <- (inner:list?)))
(gensym-prefix (string? <- (inner:list?)))
(gensym? (boolean? <- (inner:list? something?)))
(get-bytevector-all (bytevector? <- (inner:list?)))
(get-bytevector-all (bytevector? <- (inner:list? input-port?)))
(get-bytevector-n (bytevector? <- (inner:list? integer?)))
(get-bytevector-n (bytevector? <- (inner:list? input-port? integer?)))
(get-bytevector-n! (integer? <- (inner:list? input-port? bytevector? integer? integer?)))
(get-bytevector-some (bytevector? <- (inner:list?)))
(get-bytevector-some (bytevector? <- (inner:list? input-port?)))
(get-bytevector-some! (integer? <- (inner:list? input-port? bytevector? integer?)))
(get-char (char? <- (inner:list?)))
(get-char (char? <- (inner:list? input-port?)))
(get-datum (something? <- (inner:list?)))
(get-datum (something? <- (inner:list? input-port?)))
(get-datum/annotations (something? <- (inner:list?)))
(get-datum/annotations (something? <- (inner:list? input-port?)))
(get-line (string? <- (inner:list?)))
(get-line (string? <- (inner:list? input-port?)))
(get-output-string (string? <- (inner:list? output-port?)))
(get-process-id (integer? <- (inner:list?)))
(get-string-all (string? <- (inner:list?)))
(get-string-all (string? <- (inner:list? input-port?)))
(get-string-n (string? <- (inner:list? integer?)))
(get-string-n (string? <- (inner:list? input-port? integer?)))
(get-string-n! (integer? <- (inner:list? input-port? string? integer? integer?)))
(get-string-some (string? <- (inner:list?)))
(get-string-some (string? <- (inner:list? input-port?)))
(get-string-some! (integer? <- (inner:list? input-port? string? integer?)))
(get-thread-id (integer? <- (inner:list?)))
(get-u8 (integer? <- (inner:list?)))
(get-u8 (integer? <- (inner:list? input-port?)))
(getenv (string? <- (inner:list? string?)))
(greatest-fixnum (fixnum? <- (inner:list? )))
(guardian? (boolean? <- (inner:list? something?)))
(hashtable-cell ((inner:pair? something? something?) <- (inner:list? hashtable? something? something?)))
(hashtable-cells ((inner:list? (inner:pair? something? something?) ...) <- (inner:list? hashtable?)))
(hashtable-entries (something? <- (inner:list? hashtable?)))
(hashtable-keys ((inner:list? something? ...) <- (inner:list? hashtable?)))
(hashtable-mutable? (boolean? <- (inner:list? hashtable?)))
(hashtable-values ((inner:list? something? ...) <- (inner:list? hashtable?)))
(hashtable? (boolean? <- (inner:list? something?)))
(hash-table? (boolean? <- (inner:list? something?)))
(hashtable-clear! (inner:void? <- (inner:list? )))
(hashtable-clear! (inner:void? <- (inner:list? hashtable? integer?)))
...
(hashtable-delete! (inner:void? <- (inner:list? hashtable? something?)))
(hashtable-ephemeron? (boolean? <- (inner:list? something?)))
(hashtable-set! (inner:void? <- (inner:list? hashtable? something? something?)))
(hashtable-size (integer? <- (inner:list? hashtable?)))
(hashtable-update! (inner:void? <- (inner:list? hashtable? something? (something? <- something?) integer?)))
...
(identity (something? <- (inner:list? something?)))
...
(input-port-ready? (boolean? <- (inner:list?)))
(input-port-ready? (boolean? <- (inner:list? input-port?)))
...
(interaction-environment (environment? <- (inner:list?)))
...
(latin-1-codec (something? <- (inner:list?)))
...
(library-directories ((inner:list? string? ...) <- (inner:list?)))
(library-directories ((inner:list? string? ...) <- (inner:list? (inner:list? string? ...))))
(library-exports ((inner:list? something? ...) <- (inner:list? (inner:list? something? **1))))
(library-extensions ((inner:list? string? ...) <- (inner:list?)))
(library-extensions ((inner:list? string? ...) <- (inner:list? (inner:list? string? ...))))
...
(list* ((inner:pair? something? something?) <- (inner:list? something? something? **1)))
...
(load-library (inner:void? <- (inner:list? string?)))
(load-program (inner:void? <- (inner:list? string?)))
(load-shared-object (inner:void? <- (inner:list? string?)))
(load (inner:void? <- (inner:list? string?)))
(load-shared-object (something? <- (inner:list? string?)))
...
(lookahead-char (char? <- (inner:list?)))
(lookahead-char (char? <- (inner:list? input-port?)))
(lookahead-u8 (integer? <- (inner:list?)))
(lookahead-u8 (integer? <- (inner:list? input-port?)))
(machine-type (symbol? <- (inner:list? )))
(magnitude-squared (number? <- (inner:list? number?)))
(magnitude (number? <- (inner:list? number?)))
(make-assertion-violation (something? <- (inner:list?)))
(make-bytevector (bytevector? <- (inner:list? integer?)))
(make-bytevector (bytevector? <- (inner:list? integer? integer?)))
(make-compile-time-value (compile-time-value? <- (inner:list? something?)))
(make-condition ((inner:list? something? ...) <- (inner:list? something? ...)))
...
(make-error (something? <- (inner:list?)))
...
(make-i/o-error (something? <- (inner:list?)))
(make-i/o-read-error (something? <- (inner:list?)))
(make-i/o-write-error (something? <- (inner:list?)))
(make-irritants-condition (something? <- (inner:list? something?)))
(make-list ((inner:list? something? ...) <- (inner:list? integer?)))
(make-list ((inner:list? something? ...) <- (inner:list? integer? something?)))
(make-message-condition (something? <- (inner:list? string?)))
(make-mutex (mutex? <- (inner:list?)))
(make-mutex (mutex? <- (inner:list? something?)))
(make-parameter (something? <- (inner:list? something?)))
(make-parameter (something? <- (inner:list? something? (something? <- (inner:list? something?)))))
(make-record-constructor-descriptor (record-constructor-descriptor? <- (inner:list? record-type-descriptor? something? something?)))
(make-record-type-descriptor (record-type-descriptor? <- (inner:list? symbol? something? boolean? boolean? something?)))
(make-source-condition (something? <- (inner:list? something? something? something?)))
(make-source-file-descriptor (source-file-descriptor? <- (inner:list? string? string?)))
(make-source-file-descriptor (source-file-descriptor? <- (inner:list? string? string? integer?)))
(make-source-object (source-object? <- (inner:list? source-file-descriptor? integer? integer?)))
(make-source-object (source-object? <- (inner:list? source-file-descriptor? integer? integer? integer? integer?)))
(make-string (string? <- (inner:list? integer?)))
(make-string (string? <- (inner:list? integer? char?)))
(make-time (time? <- (inner:list? symbol? integer? integer?)))
(make-transcoder (transcoder? <- (inner:list? something?)))
(make-transcoder (transcoder? <- (inner:list? something? something?)))
(make-transcoder (transcoder? <- (inner:list? something? something? something?)))
(make-vector ((inner:vector? something? ...) <- (inner:list? integer? something?)))
(make-warning (something? <- (inner:list?)))
(make-weak-eq-hashtable (eq-hashtable? <- (inner:list? )))
(make-weak-eq-hashtable (eq-hashtable? <- (inner:list? integer?)))
(make-who-condition (something? <- (inner:list? something?)))
(map ((inner:list? something? ...) <- (inner:list? (something? <-(inner:list? something?)) (inner:list? something? ...) **1)))
(max (real? <- (inner:list? real? real?)))
(maximum-memory-bytes (integer? <- (inner:list?)))
...
(merge! (inner:void? <- (inner:list? (something? <-(inner:list? something?)) (inner:list? something? ...) (inner:list? something? ...))))
...
(mkdir (inner:void? <- (inner:list? string?)))
(mkdir (inner:void? <- (inner:list? string? integer?)))
...
(mutex-acquire (inner:void? <- (inner:list? mutex?)))
(mutex-acquire (boolean? <- (inner:list? mutex? boolean?)))
(mutex-release (inner:void? <- (inner:list? mutex?)))
(mutex? (boolean? <- (inner:list? something?)))
(nan? (boolean? <- (inner:list? real?)))
(native-transcoder (transcoder? <- (inner:list?)))
(negative? (boolean? <- (inner:list? real?)))
(newline (inner:void? <- (inner:list? )))
...
(null-environment (environment? <- (inner:list? integer?)))
(null? (boolean? <- (inner:list? something?)))
(number->string (string? <- (inner:list? number?)))
(number->string (string? <- (inner:list? number? integer?)))
(number? (boolean? <- (inner:list? something?)))
(numerator (number? <- (inner:list? rational?)))
(object-counts (integer? <- (inner:list? )))
(object-counts (something? <- (inner:list?)))
(odd? (boolean? <- (inner:list? integer?)))
(open-bytevector-input-port (input-port? <- (inner:list? bytevector?)))
(open-bytevector-input-port (input-port? <- (inner:list? bytevector? transcoder?)))
(open-bytevector-output-port (output-port? <- (inner:list?)))
(open-bytevector-output-port (output-port? <- (inner:list? transcoder?)))
(open-fd-input-port (input-port? <- (inner:list? integer?)))
(open-fd-output-port (output-port? <- (inner:list? integer?)))
(open-file-input-port (input-port? <- (inner:list? string?)))
(open-file-output-port (output-port? <- (inner:list? string?)))
(open-input-file (input-port? <- (inner:list? string?)))
(open-input-file (input-port? <- (inner:list? string? something?)))
(open-input-output-file (input/output-port? <- (inner:list? string?)))
(open-input-output-file (input/output-port? <- (inner:list? string? something?)))
(open-input-string (input-port? <- (inner:list? string?)))
(open-output-file (output-port? <- (inner:list? string?)))
(open-output-file (output-port? <- (inner:list? string? something?)))
(open-output-string (output-port? <- (inner:list?)))
(open-string-input-port (input-port? <- (inner:list? string?)))
(open-string-output-port (output-port? <- (inner:list?)))
...
(path-extension (string? <- (inner:list? string?)))
(path-first (string? <- (inner:list? string?)))
(path-last (string? <- (inner:list? string?)))
(path-parent (string? <- (inner:list? string?)))
(path-rest (string? <- (inner:list? string?)))
(path-root (string? <- (inner:list? string?)))
(peek-char (char? <- (inner:list?)))
(peek-char (char? <- (inner:list? input-port?)))
(petite? (boolean? <- (inner:list? )))
(port-closed? (boolean? <- (inner:list? port?)))
(port-eof? (boolean? <- (inner:list?)))
(port-eof? (boolean? <- (inner:list? input-port?)))
(port-length (integer? <- (inner:list? port?)))
(port-position (integer? <- (inner:list? port?)))
(port-transcoder (transcoder? <- (inner:list? port?)))
(port? (boolean? <- (inner:list? something?)))
(positive? (boolean? <- (inner:list? real?)))
(pretty-print (inner:void? <- (inner:list? something?)))
(pretty-print (inner:void? <- (inner:list? something? textual-port?)))
(procedure-arity-mask (integer? <- (inner:list? procedure?)))
(procedure? (boolean? <- (inner:list? something?)))
(put-bytevector (inner:void? <- (inner:list? bytevector?)))
(put-bytevector (inner:void? <- (inner:list? output-port? bytevector?)))
(put-bytevector (inner:void? <- (inner:list? output-port? bytevector? integer? integer?)))
(put-bytevector-some (inner:void? <- (inner:list? bytevector?)))
(put-bytevector-some (inner:void? <- (inner:list? output-port? bytevector?)))
(put-char (inner:void? <- (inner:list? char?)))
(put-char (inner:void? <- (inner:list? output-port? char?)))
(put-datum (inner:void? <- (inner:list? something?)))
(put-datum (inner:void? <- (inner:list? output-port? something?)))
(put-hash-table! (inner:void? <- (inner:list? hash-table? something? something?)))
(put-string (inner:void? <- (inner:list? string?)))
(put-string (inner:void? <- (inner:list? output-port? string?)))
(put-string (inner:void? <- (inner:list? output-port? string? integer? integer?)))
(put-string-some (inner:void? <- (inner:list? string?)))
(put-string-some (inner:void? <- (inner:list? output-port? string?)))
(put-u8 (inner:void? <- (inner:list? integer?)))
(put-u8 (inner:void? <- (inner:list? output-port? integer?)))
(putenv (inner:void? <- (inner:list? string? string?)))
(quotient (integer? <- (inner:list? integer? integer?)))
(raise (something? <- (inner:list? something?)))
(raise-continuable (something? <- (inner:list? something?)))
...
(read-token (something? <- (inner:list?)))
(read-token (something? <- (inner:list? input-port?)))
...
(record-accessor (something? <- (inner:list? record-type-descriptor? integer?)))
(record-constructor (something? <- (inner:list? record-constructor-descriptor?)))
(record-mutator (inner:void? <- (inner:list? record-type-descriptor? integer? something?)))
(record-predicate (boolean? <- (inner:list? record-type-descriptor? something?)))
(record-type-field-names ((inner:list? something? ...) <- (inner:list? record-type-descriptor?)))
(record-type-generative? (boolean? <- (inner:list? record-type-descriptor?)))
(record-type-opaque? (boolean? <- (inner:list? record-type-descriptor?)))
(record-type-parent (something? <- (inner:list? record-type-descriptor?)))
(record-type-sealed? (boolean? <- (inner:list? record-type-descriptor?)))
(record-type-uid (something? <- (inner:list? record-type-descriptor?)))
...
(remove-hash-table! (inner:void? <- (inner:list? hashtable? something?)))
(remove ((inner:list? something? ...) <- (inner:list? something? (inner:list? something? ...))))
...
(remv ((inner:list? something? ...) <- (inner:list? something? (inner:list? something? ...))))
(rename-file (inner:void? <- (inner:list? string? string?)))
(reset-cost-center! (inner:void? <- (inner:list? )))
(reset-maximum-memory-bytes! (inner:void? <- (inner:list? )))
(reverse! ((inner:list? something? ...) <- (inner:list? (inner:list? something? ...))))
(reverse ((inner:list? something? ...) <- (inner:list? (inner:list? something? ...))))
(round (integer? <- (inner:list? real?)))
(scheme-environment (environment? <- (inner:list?)))
(scheme-version (string? <- (inner:list?)))
(scheme-version-number (integer? <- (inner:list?)))
(serious-condition? (boolean? <- (inner:list? something?)))
(set-box! (inner:void? <- (inner:list? box? something?)))
(set-car! (inner:void? <- (inner:list? (inner:pair? something? something?) something?)))
(set-cdr! (inner:void? <- (inner:list? (inner:pair? something? something?) something?)))
(set-port-bol! (inner:void? <- (inner:list? output-port? something?)))
(set-port-eof! (inner:void? <- (inner:list? input-port? something?)))
(set-port-position! (inner:void? <- (inner:list? port? integer?)))
(set-time-nanosecond! (inner:void? <- (inner:list? time? integer?)))
(set-time-second! (inner:void? <- (inner:list? time? integer?)))
(set-time-type! (inner:void? <- (inner:list? time? symbol?)))
(simple-conditions ((inner:list? something? ...) <- (inner:list? condition?)))
(sinh (number? <- (inner:list? number?)))
(sin (number? <- (inner:list? number?)))
(sleep (inner:void? <- (inner:list? time?)))
(sleep (inner:void? <- (inner:list? integer?)))
(source-condition-form (something? <- (inner:list? something?)))
(source-condition? (boolean? <- (inner:list? something?)))
(source-directories ((inner:list? string? ...) <- (inner:list?)))
(source-directories ((inner:list? string? ...) <- (inner:list? (inner:list? string? ...))))
(source-file-descriptor-checksum (integer? <- (inner:list? source-file-descriptor?)))
(source-file-descriptor-path (string? <- (inner:list? source-file-descriptor?)))
(source-file-descriptor? (boolean? <- (inner:list? something?)))
(source-object-bfp (integer? <- (inner:list? source-object?)))
(source-object-column (integer? <- (inner:list? source-object?)))
(source-object-efp (integer? <- (inner:list? source-object?)))
(source-object-line (integer? <- (inner:list? source-object?)))
(source-object-sfd (source-file-descriptor? <- (inner:list? source-object?)))
(source-object? (boolean? <- (inner:list? something?)))
(source-table? (boolean? <- (inner:list? something?)))
(sqrt (number? <- (inner:list? number?)))
(sstats-difference (sstats? <- (inner:list? sstats? sstats?)))
(sstats-print (inner:void? <- (inner:list? sstats?)))
(sstats? (boolean? <- (inner:list? something?)))
(standard-error-port (output-port? <- (inner:list?)))
(standard-input-port (input-port? <- (inner:list?)))
(standard-output-port (output-port? <- (inner:list?)))
(string->bytevector (bytevector? <- (inner:list? string?)))
(string->utf16 (bytevector? <- (inner:list? string?)))
(string->utf16 (bytevector? <- (inner:list? string? something?)))
(string->utf32 (bytevector? <- (inner:list? string?)))
(string->utf32 (bytevector? <- (inner:list? string? something?)))
(string->utf8 (bytevector? <- (inner:list? string?)))
...
(string-copy! (inner:void? <- (inner:list? string? integer? string? integer? integer?)))
(string-copy (string? <- (inner:list? string?)))
(string-downcase (string? <- (inner:list? string?)))
(string-fill! (inner:void? <- (inner:list? string? char?)))
...
(string-set! (inner:void? <- (inner:list? string? integer? char?)))
(string-titlecase (string? <- (inner:list? string?)))
(string-truncate! (inner:void? <- (inner:list? string? integer?)))
...
(subst ((inner:list? something? ...) <- (inner:list? something? something? (inner:list? something? ...))))
(subtract-duration (time? <- (inner:list? time? time?)))
...
(symbol-hashtable-delete! (inner:void? <- (inner:list? hashtable? something?)))
(symbol-hashtable-ref (something? <- (inner:list? hashtable? something? something?)))
(symbol-hashtable-set! (inner:void? <- (inner:list? hashtable? something? something?)))
(symbol-hashtable-update! (inner:void? <- (inner:list? hashtable? something? something? (something? <- something?) something?)))
(symbol-hash (integer? <- (inner:list? symbol?)))
(syntax-violation? (boolean? <- (inner:list? something?)))
(system (inner:void? <- (inner:list? string?)))
...
(time-utc->date (date? <- (inner:list? time? integer?)))
...
(trace-output-port (output-port? <- (inner:list?)))
(transcoder-codec (something? <- (inner:list? transcoder?)))
(transcoder-eol-style (something? <- (inner:list? transcoder?)))
(transcoder-error-handling-mode (something? <- (inner:list? transcoder?)))
(transcoder? (boolean? <- (inner:list? something?)))
(truncate (real? <- (inner:list? real?)))
(truncate-file (inner:void? <- (inner:list? string? integer?)))
(u8-list->bytevector (bytevector? <- (inner:list? (inner:list? integer? ...))))
(undefined-violation? (boolean? <- (inner:list? something?)))
(unget-char (inner:void? <- (inner:list? char?)))
(unget-char (inner:void? <- (inner:list? input-port? char?)))
(unget-u8 (inner:void? <- (inner:list? integer?)))
(unget-u8 (inner:void? <- (inner:list? input-port? integer?)))
(unless (something? <- (inner:list? something? something? **1)))
(unread-char (inner:void? <- (inner:list? char?)))
(utf-16-codec (something? <- (inner:list?)))
(utf-16be-codec (something? <- (inner:list?)))
(utf-16le-codec (something? <- (inner:list?)))
(utf-8-codec (something? <- (inner:list?)))
(utf16->string (string? <- (inner:list? bytevector? symbol? )))
(utf16->string (string? <- (inner:list? bytevector? symbol? boolean? )))
(utf32->string (string? <- (inner:list? bytevector?)))
(utf32->string (string? <- (inner:list? bytevector? something?)))
(utf8->string (string? <- (inner:list? bytevector?)))
(values (something? <- (inner:list? something? ...)))
...
(vector-cas! (inner:void? <- (inner:list? (inner:vector? something? ...) integer? something? something?)))
...
(vector-set! (inner:void? <- (inner:list? (inner:vector? something? ...) integer? something?)))
(vector-set-fixnum! (inner:void? <- (inner:list? (inner:vector? something? ...) integer? fixnum?)))
(vector-sort! (inner:void? <- (inner:list? (something? <- (inner:list? something?)) (inner:vector? something? ...) )))
...
(with-exception-handler (something? <- (inner:list? (something? <- (inner:list? something?)) (something? <- (inner:list? something? ...)))))
(with-input-from-file (something? <- (inner:list? string? (something? <- (inner:list?)))))
(with-input-from-string (something? <- (inner:list? string? (something? <- (inner:list?)))))
(with-mutex (something? <- (inner:list? mutex? (something? <- (inner:list? something? ...)))))
(with-output-to-file (something? <- (inner:list? string? (something? <- (inner:list?)))))
(with-output-to-string (string? <- (inner:list? (something? <- (inner:list?)))))
(write-char (inner:void? <- (inner:list? char?)))
(write (inner:void? <- (inner:list? something?)))
